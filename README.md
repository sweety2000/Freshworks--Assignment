...
Operating system: Windows 10 Python: Python3.6 or higher Install Python dependency packages: python3 -m pip install -r requirements.txt Run app.py to run the backend server. To start datastore from default file location, run python3 app.py To start datastore from user defined file location, run python3 app.py --datastore=<absolute_path_of_your_datastore>
